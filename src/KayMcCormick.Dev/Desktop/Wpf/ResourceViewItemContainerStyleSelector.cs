...
{
    /// <summary>
    ///   <para>This is the item container style selector for the TreeView that hosts the resources tree. The logic is very simple - if the item is of type (or ubtype of) ResourceNodeInfo then it uses the style named "</para>
    ///   <para></para>
    /// </summary>
    ...
    public class ResourceViewItemContainerStyleSelector : StyleSelector
    {
        ...
        /// The logic is very simple it ues a stlye named DefaultResourceNodeInfoStyle if the item is f type or subtype ResourceNodeInfo
        /// </summary>
