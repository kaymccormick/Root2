...
namespace AnalysisAppLib
{
    ...
    public static class AnalysisService
    {
            ...
            , [NotNull] string assemblyName, bool extraRefs = true, string filename = null)
        {
            ...
            var syntaxTree = CSharpSyntaxTree.ParseText ( code, new CSharpParseOptions(LanguageVersion.CSharp7_3), filename ) ;
        ...
        {
            {
                ...
                var syntaxTree = CSharpSyntaxTree.ParseText(code, new CSharpParseOptions(LanguageVersion.CSharp7_3), file);
