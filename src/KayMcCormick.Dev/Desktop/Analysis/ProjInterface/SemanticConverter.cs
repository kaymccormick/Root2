...
{
    internal sealed class SemanticConverter : IValueConverter
    {
            ...
            if ( csn != null )
            {
                    ...
                    if ( m.Body != null )
                    {
                        var controlFlowAnalysis =
                            semanticModel.AnalyzeControlFlow (
                                                              m.Body.Statements.First ( )
                                                            , m.Body.Statements.Last ( )
                                                             ) ;
                ...
                if ( op != null )
                {
                    switch ( op )
                    {
                        ...
                        case IStaticLocalInitializationSemaphoreOperation
                            staticLocalInitializationSemaphoreOperation :
                            break ;
                        ...
                        case IConditionalAccessInstanceOperation conditionalAccessInstanceOperation
                            :
                            break ;
                        ...
                        case IDeclarationExpressionOperation declarationExpressionOperation :
                            break ;
                        ...
                        case IInterpolatedStringTextOperation interpolatedStringTextOperation :
                            break ;
                        ...
                        case ISingleValueCaseClauseOperation singleValueCaseClauseOperation :
                            break ;
                        ...
                        case IInterpolatedStringContentOperation interpolatedStringContentOperation
                            :
                            foreach ( var operation in interpolatedStringContentOperation.Children )
                            {
                            }
