...
namespace FindLogUsages
{
    ...
    public static class Transforms
    {
                ...
                switch ( expressionSyntaxNode )
                {
                    ...
                    case LiteralExpressionSyntax lit :
                        return new
                               {
                                   lit.RawKind
                                 , Kind    = lit.Kind ( ).ToString ( )
                                 , Literal = lit.Token.Value
                               } ;
        ...
        private static object TransformPatternSyntax ( PatternSyntax isPatternPattern )
        {
            switch ( isPatternPattern )
            {
                ...
                case DiscardPatternSyntax discardPatternSyntax :
                    return new
                           {
                               discardPatternSyntax.RawKind
                             , Kind = discardPatternSyntax.Kind ( ).ToString ( )
                           } ;
            ...
            return new UnsupportedExpressionTypeSyntaxException (
                                                                 isPatternPattern
                                                                    .Kind ( )
                                                                    .ToString ( )
                                                                ) ;
        ...
        public static object TransformIdentifier ( in SyntaxToken argIdentifier )
        {
            return new
                   {
                       argIdentifier.RawKind
                     , Kind = argIdentifier.Kind ( ).ToString ( )
                     , argIdentifier.Value
                   } ;
        }
        ...
        public static object TransformStatement ( [ NotNull ] StatementSyntax arg )
        {
            ...
            switch ( arg )
            {
                ...
                case LocalDeclarationStatementSyntax localDeclarationStatementSyntax :
                    return new
                           {
                               localDeclarationStatementSyntax.RawKind
                             , Kind = localDeclarationStatementSyntax.Kind ( ).ToString ( )
                             , Declaration =
                                   TransformVariableDeclarationSyntax (
        ...
        private static object TransformVariableDeclarationSyntax (
            ...
            return new
                   {
                     ...
                     , Type = TransformTypeSyntax ( declaration.Type )
                     , Variables =
                           declaration.Variables.Select ( TransformVariableDeclaratorSyntax )
                   } ;
        }

        private static object TransformVariableDeclaratorSyntax ( VariableDeclaratorSyntax arg )
        {
            return new
                   {
                       arg.RawKind
                     , Kind       = arg.Kind ( ).ToString ( )
                     , Identifier = TransformSyntaxToken ( arg.Identifier )
                   } ;
        }
        ...
        /// <param name="arg"></param>
        /// <returns></returns>
        public static object TransformInterpolated (
            [ NotNull ] InterpolatedStringContentSyntax arg
        )
        {
            if ( arg == null )
            {
        ...
        public static object TransformSyntaxNode ( [ NotNull ] SyntaxNode syntaxNode )
        {
            ...
            switch ( syntaxNode )
            {
                ...
                case StatementSyntax st :          return TransformStatement ( st ) ;
            }
        ...
        private static object TransformMemberDeclarationSyntax ( MemberDeclarationSyntax arg )
        {
            switch ( arg )
            {
                ...
                case FieldDeclarationSyntax fieldDeclarationSyntax :
                    return new { fieldDeclarationSyntax.RawKind } ;
