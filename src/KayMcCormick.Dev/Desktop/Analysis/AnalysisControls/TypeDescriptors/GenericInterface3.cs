...
namespace AnalysisControls.TypeDescriptors
{
    ...
    /// 
    /// </summary>
    public class GenericInterface3 : Control
    {
        /// <summary>
        /// 
        /// </summary>
        public static readonly DependencyProperty TypeDescriptorProperty = DependencyProperty.Register(
            "TypeDescriptor", typeof(ICustomTypeDescriptor), typeof(GenericInterface3),
        ...
        {
            ((GenericInterface3) d).OnTypeDescriptorChanged((ICustomTypeDescriptor) e.OldValue,
        ...
        public static readonly DependencyProperty PropertiesProperty = DependencyProperty.Register(
            "Properties", typeof(PropertyDescriptorCollection), typeof(GenericInterface3),
        ...
        {
            ((GenericInterface3) d).OnPropertiesChanged((PropertyDescriptorCollection) e.OldValue,
        ...
        public static readonly DependencyProperty InstanceProperty = DependencyProperty.Register(
            "Instance", typeof(object), typeof(GenericInterface3),
        ...
        {
            ((GenericInterface3) d).OnInstanceChanged((object) e.OldValue, (object) e.NewValue);
        }
        ...
        {
            ((GenericInterface3) d).OnInstancePropertiesChanged((IEnumerable) e.OldValue, (IEnumerable) e.NewValue);
        }


        /// <inheritdoc />
        public GenericInterface3()
        {
        ...
        static GenericInterface3()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(GenericInterface3),
                new FrameworkPropertyMetadata(typeof(GenericInterface3)));
        ...
        public override void OnApplyTemplate()
        {
            ...
            _listView = (PropItems) GetTemplateChild("ListView");
