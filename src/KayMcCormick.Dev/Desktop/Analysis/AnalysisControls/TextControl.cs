...
namespace AnalysisControls
{
    ...
    public class TextControl : Control, ILineDrawer
    {
        ...
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(
            "Source", typeof(IEnumerable), typeof(TextControl), new PropertyMetadata(default(IEnumerable), OnSourceChanged));
        ...
        {
            ((TextControl) d).OnSourceChanged((IEnumerable) e.OldValue, (IEnumerable) e.NewValue);
        }
