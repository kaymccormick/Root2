...
namespace KayMcCormick.Dev
{
    ...
    public sealed class DefaultObjectIdProvider : IObjectIdProvider
    {
        ...
        public int GetInstanceCount ( [ NotNull ] IComponentRegistration reg )
        {
            if ( reg == null )
            {
                throw new ArgumentNullException ( nameof ( reg ) ) ;
        ...
        [ NotNull ]
        public object GetObjectInstanceIdentifier ( [ NotNull ] object instance )
        {
        ...
        /// <returns></returns>
        [ CanBeNull ]
        public object GetObjectById ( [ NotNull ] object id )
        {
