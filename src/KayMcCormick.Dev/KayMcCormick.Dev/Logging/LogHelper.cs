...
namespace KayMcCormick.Dev.Logging
{
    public static class LogHelper
    {
        ...
        /// <summary>Gets or sets the name of the console target.</summary>
        /// <value>The name of the console target.</value>
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for ConsoleTargetName
        public static string ConsoleTargetName { get { return _consoleTargetName ; } set { _consoleTargetName = value ; } }

        /// <summary>Gets or sets the name of the event log target.</summary>
        /// <value>The name of the event log target.</value>
        /// <autogeneratedoc />
        ...
        )
        {
            ...
            var t = _dict[config1.MinLogLevel];
            var errorTargets = config1.MinLogLevel <= LogLevel.Error ? _dict[LogLevel.Error] : null ;
 ...
 new EndpointAddress("http://exomail-87976:8737/discovery/scenarios/logreceiver/");
            ...
            foreach ( var result in _dict.Select (pair =>  LoggingRule(pair, config1.MinLogLevel, config1) ) )
            {
            ...
            NLog.Logger                   = LogManager.GetCurrentClassLogger ( ) ;
            return useFactory ;
        }
