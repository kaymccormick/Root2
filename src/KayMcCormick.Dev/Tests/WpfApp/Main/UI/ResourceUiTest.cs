...
namespace Tests.Main.UI
{
    ...
    /// <summary>Tests the type navigator.</summary>
        ...
        private static void StructureChangedEventHandler ( object sender , StructureChangedEventArgs args )
        {
        ...
        // ReSharper disable once InternalOrPrivateMemberNotDocumented
        private static AutomationElementCollection FindHyperlinks ( AutomationElement autoElem )
        {
        ...
        // ReSharper disable once InternalOrPrivateMemberNotDocumented
        private static AutomationElement FindControlAutomationElement ( string controlName )
        {
        ...
        // ReSharper disable once InternalOrPrivateMemberNotDocumented
        private static string SetupTypeNavControl ( out TypeNavigator control )
        {
