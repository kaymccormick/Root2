...
namespace Tests.Main
{
      ...
      , IDisposable
    {
        ...
        public async Task TestProject3 ( string p1 , string proj , string doc )
        {
            Assert.NotNull ( VSI ) ;
            var root = @"C:\Users\mccor.LAPTOP-T6T0BN1K\source\repos" ;
            var p = Path.Combine ( root , p1 ) ;
            ...
            var theDocument = projectHandlerImpl.Workspace.CurrentSolution.Projects
                                                ...
                                                .Documents
                                                .Single ( document => document.Name == doc ) ;
            await projectHandlerImpl.OnPrepareProcessDocumentAsync ( theDocument ) ;
            await projectHandlerImpl.OnProcessDocumentAsync (
                                                             theDocument
                                                           , invocation => {
        ...
        {
            var f = Utils.MakeFormattedCode ( out var w ) ;
