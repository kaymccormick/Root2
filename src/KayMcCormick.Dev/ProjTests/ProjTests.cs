...
namespace ProjTests
{
      ...
      , IDisposable
    {
        ...
        public void TestViewModel1 ( )
        {
            ...
            var vsInstance = viewModel.VsCollection.First ( ) ;
            ...
            var solution = @"V3\Root\src\KayMcCormick.Dev\KayMcCormick.Dev.sln" ;
            //solution = @"V2\LogTest\LogTest.sln";

            MSBuildLocator.RegisterInstance ( VSI ) ;

            var spath = Path.Combine ( root , solution ) ;
            viewModel.PipelineViewModel.Pipeline.PipelineInstance.Post (spath) ;
