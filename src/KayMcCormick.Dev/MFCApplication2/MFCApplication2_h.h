...
#ifndef __CMFCApplication2Doc_FWD_DEFINED__
#define __CMFCApplication2Doc_FWD_DEFINED__

#ifdef __cplusplus
typedef class CMFCApplication2Doc CMFCApplication2Doc;
#else
typedef struct CMFCApplication2Doc CMFCApplication2Doc;
#endif /* __cplusplus */

#endif 	/* __CMFCApplication2Doc_FWD_DEFINED__ */
...
EXTERN_C const IID DIID_IMFCApplication2;
    ...
    MIDL_INTERFACE("c5479669-06a2-4cff-9e47-a19d41ba285c")
...
EXTERN_C const CLSID CLSID_CMFCApplication2Doc;

#ifdef __cplusplus

class DECLSPEC_UUID("391952e8-8034-4e6a-9381-e38314850652")
CMFCApplication2Doc;
#endif
